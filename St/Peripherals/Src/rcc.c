...
//Milisecond ticks
static __IO uint32_t msTicks=0; //static makes it available in this file and volatile says that to compiler this value can be modified from some where else not in a routine execution like interrupt
